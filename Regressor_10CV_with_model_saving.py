        ...
        try:
            ...
            if model_name == 'SVR':  # Code for SVR regression
                ...
                for fold_index, (train_index, test_index) in enumerate(kf.split(X)):
                    ...
                    model_filename = f"{debug_dir}/{script_name}_{base_file_name}_SVR_model.pkl"
                ...
                for fold_index, (train_index, test_index) in enumerate(kf.split(X)):
                    ...
                    # Zapisanie modelu po wytrenowaniu
                    model_filename = f"{debug_dir}/{script_name}_{base_file_name}_AdaBoost_model.pkl"
                ...
                for fold_index, (train_index, test_index) in enumerate(kf.split(X)):
                    ...
                    model_filename = f"{debug_dir}/{script_name}_{base_file_name}_GradientBoosting_model.pkl"
